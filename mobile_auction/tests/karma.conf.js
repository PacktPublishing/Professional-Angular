  ...
  config.set({
   ...
   // list of files / patterns to load in the browser
    files: [
      ...
      {pattern: 'node_modules/common/bundles/common-http.umd.js', included: false, watched: true},
      {pattern: 'node_modules/common/bundles/common-http.umd.js.map', included: false, watched: true},

      // Angular 2 modal
      {pattern: 'node_modules/ngx-modialog/**/*.js', included: false, watched: true},
